...
public class CowMovement : MonoBehaviour
{
   ...
   // public Animator animator;
    ...
    public Vector2 decisionTime = new Vector2(1, 6);
    ...
    internal Vector3[] moveDirections = new Vector3[] { Vector3.right, Vector3.left, 
        Vector3.up, Vector3.down, Vector3.zero, Vector3.zero, Vector3.zero, new Vector3(1,1,0),  
        new Vector3(-1, -1, 0),Vector3.zero, new Vector3(-1, 1, 0), new Vector3(1, -1, 0),Vector3.zero,Vector3.zero};
    ...
    void Update()
    {
        ...
        Vector2 direction = new Vector2(moveDirections[currentMoveDirection].x, moveDirections[currentMoveDirection].y);
